        ...
        <x-eduka::responsive-breakpoints></x-eduka::responsive-breakpoints>
            <div class="px-4 sm:px-8 md:px-12 xl:container mx-auto">
                <div class="shadow-lg">
                    ...
                    <section class="w-full bg-blue-800 px-12 xl:px-32 py-12">
                        ...
                        <div class="flex flex-wrap md:flex-nowrap gap-6 sm:gap-16">
                            ...
                            <div class="w-full md:w-1/2 order-first md:order-last">
                                <img src="/vendor/mastering-nova/images/hero.jpg" class="shadow-lg rounded-lg" />
                            </div>
                            <!-- /Right hero container -->
                        </div>
                        <!-- /Inner container -->
                    ...
                    <!-- /Videos section -->
                    <!-- FAQ section -->
                    <section class="px-12 xl:px-32 py-12 bg-orange-500">
                        <p class="text-center text-2xl sm:text-3xl md:text-4xl text-blue-800 font-bold">Questions ?</p>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 pt-12">
                            <!-- Question & answer -->
                            <div class="px-4 md:px-8 lg:px-12 py-6 lg:py-12 bg-white rounded-lg">
                    ...
                    <!-- /FAQ section -->
                    <!-- Footer -->
                    <section class="px-12 xl:px-32 py-12 bg-blue-800 text-white">
